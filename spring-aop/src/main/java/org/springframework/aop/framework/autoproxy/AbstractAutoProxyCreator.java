...
public abstract class AbstractAutoProxyCreator extends ProxyProcessorSupport
	...
	public Object postProcessBeforeInstantiation(Class<?> beanClass, String beanName) {
		...
		// targetSourcedBeans
		// 在Spring代理目标bean的时候，其并不是直接创建一个目标bean的对象实例的，
		// 而是通过一个TargetSource类型的对象将目标bean进行封装，
	...
	protected Object wrapIfNecessary(Object bean, String beanName, Object cacheKey) {
		...
		// 检查当前bean是否需要代理, 基础设施类(Advice\Pointcut\Advisor\AopInfrastructureBean)或者original不需要
	...
	protected Object createProxy(Class<?> beanClass, @Nullable String beanName,
		...
		// 判断代理的是类还是接口，如果需要指定cglib代理，需要设置proxyTargetClass=true
		if (!proxyFactory.isProxyTargetClass()) {
			// 检查相应BeanDefinition的“preserveTargetClass”属性，是否代理目标类
		...
		// DefaultAdvisorChainFactory.getInterceptorsAndDynamicInterceptionAdvice获取所有的Advisors、
